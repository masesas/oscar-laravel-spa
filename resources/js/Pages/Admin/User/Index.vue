    ...
    <LayoutAuthenticated>
        ...
        <SectionMain>
            <SectionTitleLineWithButton :icon="mdiAccountKey" title="Users" main>
                <BaseButton v-if="can.delete" :route-name="route('user.create')" :icon="mdiPlus" label="Add" color="info"
                    rounded-full small />
                ...
                <table>
                    ...
                    <tbody>
                        <tr v-for="user in users.data" :key="user.id">
                            <td data-label="Name">
                                <Link :href="route('user.show', user.id)" class="
                    no-underline
                    hover:underline
                    text-cyan-600
                    dark:text-cyan-400
                ">
                            ...
                            <td v-if="can.edit || can.delete" class="before:hidden lg:w-1 whitespace-nowrap">
                                <BaseButtons type="justify-start lg:justify-end" no-wrap>
                                    <BaseButton v-if="can.edit" :route-name="route('user.edit', user.id)" color="info"
