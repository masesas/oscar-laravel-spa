...
<template>
    <LayoutAuthenticated>
        ...
        <SectionMain>
            ...
            <CardBox form @submit.prevent="form.post(route('user.update', props.user.id))">
                <FormField label="Enter Name" :class="{ 'text-red-400': form.errors.name }">
                ...
                <FormField label="Enter Email" :class="{ 'text-red-400': form.errors.email }">
                    <FormControl v-model="form.email" type="text" placeholder="Email" :error="form.errors.email">
